...
p22 = Place.new(name: "Friche de la Belle de Mai",
              interest: ["photography", "history", "music", "dance", "performing arts"],
...
p23 = Place.new(name: "Théâtre La Criée",
              ...
              description: "National drama center with a large glass roof, with exhibitions in the hall and eclectic programming. La Criée - National Theater of Marseille is a theater which has the status of National Dramatic Center. Founded in 1981 by Marcel Maréchal at 30, quai de Rive-Neuve in Marseille (France), it opens onto the Old Port.")
...
p29 = Place.new(name: "Place d'Armes",
              ...
              exterior: true,
              environment: ["sunny"],
              description: "With its village, gardens and countless little secrets, Fort Saint-Jean is a joyful labyrinth in which it is advisable to come and lose yourself!")
